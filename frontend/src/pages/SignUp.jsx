...
export default function SignUp() {
  ...
  // For loading state, if you want to disable the button or show spinner
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If your backend returns a token on registration, you can store it, e.g.:
      // const { token } = response.data
      // if (token) {
      //   localStorage.setItem("jwt_token", token)
      // }

      // Redirect user, e.g., to login or dashboard
      navigate("/login")
    } catch (err) {
