    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      >
        <div className="max-w-md mx-auto">
          ...
          >
            Join our community and discover how AI can help you understand and improve your emotional wellbeing. Create
            an account to start your personalized experience.
          </motion.p>
      ...
      >
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-400">Sign up to start your emotional wellbeing journey</p>
          </motion.div>
